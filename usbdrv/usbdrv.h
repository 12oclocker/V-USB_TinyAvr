...
/* below is the only change needed in this file for TinyAvr0 TinyAvr1 series compatability */
#if USB_CFG_TINYAVR_SERIES == 1 /* added compatability for TinyAvr0 TinyAvr1 series */
#define USB_CONCAT3(a, b, c)        a ## b ## c
#define USB_OUTPORT(name)           USB_CONCAT3(VPORT, name, _OUT) //must use VPORT because those use legacy IO address that bit instructions work on
